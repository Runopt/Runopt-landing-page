  ...
  return (
    <div className="hero-container" id="home">
      <div className="heading-wrapper">
            ...
            <div className="banner-content">
              ...
              <div className="banner-text">
                <div className="banner-line-1">
                  <span className="banner-text-platform">Collaborative Platform</span>
                </div>
                <div className="banner-line-2">
                  <span className="banner-text-maps">Interactive 3D Zoning Maps</span>
                  <span className="banner-text-plus"> + </span>
                  <span className="banner-text-logic">
                    <span className="desktop-text">Logic-Backed Feasibility Analysis</span>
                    <span className="mobile-text">Logic-Backed Feasibility Analysis</span>
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="desc">
        Collaborate early, evaluate sites faster, make smarter development decisions
        </div>
